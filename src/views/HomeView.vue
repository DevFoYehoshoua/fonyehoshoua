<template>
  ...
  >
    <div class="">
      ...
      </div> 'bg-gradient-to-b from-[#008080] to-[#00b3b3]' -->
...
const changeLanguage = (lang) => {
  locale.value = lang
  document.documentElement.className = lang // Appliquer la classe CSS pour la langue
  localStorage.setItem('language', lang) // Sauvegarder la langue sélectionnée
}
...
onMounted(() => {
  // Vérifier si Firefox est utilisé
  ...
  const observerOptions = { root: null, threshold: 0.13 }
