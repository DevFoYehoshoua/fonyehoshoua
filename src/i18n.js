...
const messages = {
  fr: {
    "objectifs": {
      ...
      "heart_description": "est pour les malheureux, les pauvres, les orphelins, les veufs(ves) et les démunis. Le fondement de nos actions vient de ce cœur et de l'amour que le Seigneur Yéhoshoua a pour les hommes.",
      ...
      "mission_description": "pour communiquer la saine doctrine, afin de partager cet amour du Seigneur par des actes concrets",
    ...
    "ezra": {
      ...
      "supports": {
        ...
        "donations": {
          ...
          "description": "Les dons spontanés et ponctuels quels qu'ils soient, selon votre conviction et dans la liberté.",
    ...
    "yaacovText": "La religion pure et sans souillure devant notre Elohim et Père, c'est de visiter les orphelins et les veuves dans leurs tribulations, et de se conserver sans tache loin du monde.",
    "whoWeAreTitle": "Qui sommes-nous ?",
    "whoWeAreText": "Nous sommes des bénévoles, membres de la diaspora Malagasy ayant foi en Yéhoshoua Ha Mashiah. Nous croyons en la puissance de la parole d'Elohim et nous voulons la partager pour que les Hommes puissent l'entendre et la vivre.",
    "ourFunctioningTitle": "Notre fonctionnement",
    "ourFunctioningText": "Nous voulons fonctionner selon les principes bibliques et travaillons en partenariat avec différentes associations ayant les mêmes valeurs.",
    "actions_title": "Nos actions dans le monde",
    "actions_distribution_title": "Distribution",
    "actions_distribution_description": "alimentaires, vestimentaires, fournitures scolaires, produits d'hygiène, divers équipements (liste non exhaustive, ...)",
    ...
    "land_acquisition_desc": "pour la mise en place de diverses structures (écoles, orphelinats, maison d'accueil...).",
    "donSpontane": "Don spontané",
    "compte": "Compte",
  ...
  "mg": {
    "objectifs": {
      ...
      "heart_description": "dia miantefa amin'ny ireo ory, ny sahirana, ny kamboty, ny mpitondratena ary ny malahelo. Io fo sy fitiavan'I Yehôshoa io no fototra ijoroan'ny asanay.",
      "reason_title": "Izany no mahatonga anay",
      "encouragement": "handrisika ny iraka any Madagasikara sy erak'izao tontolo izao",
      "mission_description": "mba hampitana ny teny tsy misy kilema, ka hizarana ilay fitiavan'Ny Tompo amin'ny alalan'ny asa azo tsapain-tànana toy ny fanohanana ireo sahirana, amin'ny lafiny rehetra.",
    ...
    "supports": {
      ...
      "donations": {
        ...
        "description": "Ireo fanomezana tsy tapaka na tokana, arak'izay fandresen-dahatrareo sy anaty fahalalahana tanteraka.",
    ...
    "soutien": {
        ...
        "siegeMpyDescription": "<b>Fanofana trano</b> ho an'ny foiben'ny fikambanana “Madagascar pour Yéhoshoua” (MPY) eto Antananarivo. <br/>Ireo toerana ireo dia ampiasaina amin'ny <b>fanatanterahana ireo hetsiky ny MPY rehetra </b>(toy ny tsena fanampiana ireo sahirana, efi-trano fampianarana (fanjairana, …), birao, fandraisana ireo mpanao iraka, …). <br/>Miara-mientana izahay hampandroso ny asan'ny Ray.",
        "siegeMpyDescriptions": "Maro ireo maty any Madagasikara noho ny tsy fahampian'ny fahaizana manasitrana. Lafo loatra ny vidin'ny fanafody sy ny fitsaboana raha oharina amin'ny karama sy ny fari-piainan'ny Malagasy maro.\n\nTamin'ny taona 2023, nanao fahasoavana i Tompo Yéhoshoua. Nanomboka nanorina ny Centre Hospitalier Pain Quotidien tany Antananarivo Madagasikara ny fikambanana Pain Quotidien niaraka tamin'ny MPY mba hanome fahafahana ireo Malagasy hotsaboina maimaim-poana.\n\nManohana ity asa ity izahay.",
    ...
    "yaacovText": "Izao no fivavahana madio sady tsy misy loto eo anatrehan'i Elohima sady Ray: ny mamangy ny kamboty sy ny mpitondratena amin'ny fahoriany, sy ny miaro ny tena tsy hisy pentimpentina avy amin'izao tontolo izao.",
    "whoWeAreTitle": "Iza moa izahay ?",
    "whoWeAreText": "Izahay dia mpilatsaka an-tsitrapo, mpikambana eo anivon'ny Malagasy miely manerantany (zanaka am-pielezana Malagasy) mino an'I Yehôshoa Ha Mashiah (Jesosy Kristy). Mino ny herin'ny tenin'i Elohima izahay ary maniry ny hizara izany mba hahafahan'ny olona mandre sy miaina azy.",
    "ourFunctioningTitle": "Ny fomba fiasanay",
    "ourFunctioningText": "Maniry ny hiasa araka ny fitsipika ao amin'ny baiboly izahay ary miara-miasa amina fikambanana samihafa mitovy foto-kevitra aminay. ",
    "actions_title": "Ny asanay maneran-tany",
    "actions_distribution_title": "Fizarana : ",
    "actions_distribution_description": "sakafo, akanjo fitafy, fitaovam-pianarana, kojakoja fidiovana, fitaovana maro samihafa sns … ",
    ...
    "land_acquisition_desc": "ho fanorenanana foto-drafitrasa isan-karazany (fianarana, fitaizana zaza kamboty, trano fandraisam-bahiny,...)",
    "donSpontane": "Fanomezana an-tsitrapo",
    "compte": "Kaonty",
