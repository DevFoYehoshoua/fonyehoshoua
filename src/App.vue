...
<template>
  <div class="h-full w-full">
    <header
      class="bg-gradient-to-r from-orange-950 to-foni-bg2 xl:grid grid-cols-4 xl:grid-cols-8 items-center gap-4 sticky top-0 z-10 xl:h-32 xl:max-h-32"
    >
      <div
        id="full-menu"
        class="hidden xl:grid xl:grid-cols-5 col-span-5 xl:row-span-3 col-start-3 gap-4 justify-items-center items-center justify-center text-center xl:mb-24"
      >
        <a
          @click="scrollToSection('qui')"
          class="text-lg 2xl:text-xl text-foni-white font-bold hover:text-foni-green cursor-pointer"
          >Qui sommes nous?</a
        >
      ...
      <div
        ...
        class="col-span-2 col-start-1 flex w-24 sm:w-32 md:w-36 xl:w-32 cursor-pointer items-center self-center xl:mb-16 xl:max-h-32"
      >
        <img
          alt="Vue logo"
        ...
        <img
          ...
          class="2xl:w-full xl:mb-4 xl:ml-4"
          width="125"
          height="125"
        />
      </div>
